...
export default function Home() {
    ...
    useEffect(() => {
        // Small delay after mount so CSS transitions fire
    ...
    return (
        ...
        >
            ...
            {/* Pill badge — fades down from top */}
            <div style={{
                ...base,
                ...(visible
        ...
        <span style={{
            ...
            {/* "Where Data" — slides up first */}
            <div style={{ position: "relative", zIndex: 5, lineHeight: 1.1 }}>
                <div style={{
                    ...base,
                    ...(visible ? shown : hidden),
